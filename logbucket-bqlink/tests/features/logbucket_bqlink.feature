...
Feature: LogBucket BigQuery Link Security and Encryption Compliance
  ...
  Scenario: Validate Logging Bucket specifies CMEK key settings
  ...
  Scenario: Validate Logging Bucket does not allow public access
    Given the logging bucket configuration is inspected
