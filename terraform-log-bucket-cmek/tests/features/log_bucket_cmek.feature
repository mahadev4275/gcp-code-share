...
Feature: [CMEK Log Bucket] CMEK Settings & KMS Key Rotation
  ...
  Scenario: [CMEK Log Bucket] Validate Logging Bucket specifies valid CMEK settings and KMS key rotation
  ...
  Scenario: [CMEK Log Bucket] Validate KMS Crypto Key IAM binding does not use wildcards
