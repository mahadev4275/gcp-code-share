...
Feature: BigQuery Cross Project IAM Access Compliance
  ...
  Scenario: Validate IAM permissions do not use wildcards
  ...
  Scenario: Validate BigQuery dataset IAM does not permit public access
    Given the BigQuery dataset IAM member configuration is inspected
