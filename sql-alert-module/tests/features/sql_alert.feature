...
Feature: [SQL Alert Module] GA API & Alert Policy Compliance
  ...
  Scenario: [SQL Alert Module] Validate Cloud Monitoring API enablement service
  ...
  Scenario: [SQL Alert Module] Validate SQL alert policy notification channel and periodicity
