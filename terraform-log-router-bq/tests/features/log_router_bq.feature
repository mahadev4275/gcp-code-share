...
Feature: Log Router BigQuery Sink Encryption and Access Control
  ...
  Scenario: Validate BigQuery dataset for log router specifies CMEK encryption
  ...
  Scenario: Validate Log Sink writer identity IAM binding does not use wildcards
