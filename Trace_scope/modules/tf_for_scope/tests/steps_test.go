...
func (c *bddContext) registerSteps(sc *godog.ScenarioContext) {
	sc.Step(`^the trace scope configuration is inspected$`, func() error { return nil })
	sc.Step(`^the trace scope resource names must be valid project resource URIs$`, c.verifyValidURIs)
}

func (c *bddContext) verifyValidURIs() error {
